...
Tinker.prototype.digitalWrite = function(pin, value, callback) {
  ...
  console.log('param:', pin + ',' + value);
  this.spark.callFunction(this.coreId, 'digitalwrite', pin + ',' + value, callback);
};

Tinker.prototype.digitalRead = function(pin, value, callback) {
  this.spark.callFunction(this.coreId, 'digitalread', pin + ',' + value, callback);
};

Tinker.prototype.analogRead = function(pin, value, callback) {
  this.spark.callFunction(this.coreId, 'analogread', pin + ',' + value, callback);
};
